...
import com.ducksoup.dilivideotext.controller.params.PostCommentParams;
import com.ducksoup.dilivideotext.controller.params.ReplyPostCommentParams;
...
import com.ducksoup.dilivideotext.mainservices.MyPostCommentService;
import com.ducksoup.dilivideotext.mainservices.action.PostCommentLikeService;
import com.ducksoup.dilivideotext.utils.OSSUtils;
import com.ducksoup.dilivideotext.dto.IdMap;
import com.ducksoup.dilivideotext.service.PostCommentReplyCommentService;
import com.ducksoup.dilivideotext.service.PostCommentService;
import com.ducksoup.dilivideotext.service.PostCommentToPostService;
...
public class PostCommentController {
    ...
    public ResponseResult<List<PostCommentVo>> getComments(@RequestParam Integer page, @RequestParam Integer pageSize, @RequestParam String postId, @RequestParam boolean orderByTime) {
        ...
        postCommentLikeService.setPostCommentLikeStatus(response,StpUtil.isLogin()? (String) StpUtil.getLoginId() :null);
